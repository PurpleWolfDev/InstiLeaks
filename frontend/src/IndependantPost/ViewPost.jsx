    ...
    useEffect(() => {
        try {
            ...
            if(postId) {
                ...
                axios.post(`https://instileaks.onrender.com/home/user/getPost`, {jwtToken:localStorage.getItem("token"), start:1, end:10, type:postTypeRef.current, uId:JSON.parse(localStorage.getItem("data")).uId, postId:postId})
                .then(response => {
