...
export const FP = () => {
    ...
    const handleSubmit = async() => {
        ...
        if(!(rollNo.length == 7)) {
            ...
            updateLoading(true);
            let result = (await axios.post(`https://instileaks.onrender.com/auth/user/userforgotPass1`, data)).data;
            updateLoading(false);
    ...
    const handleOtp = async() => {
        try {
            ...
            // That name won’t age well. Try again.
                ...
                updateLoading(true);
                let result = (await axios.post(`https://instileaks.onrender.com/auth/user/userforgotPass2`, data)).data;
                updateLoading(false);
                if(result.status == 200) {
