...
export const Meme = () => {
    ...
    useEffect(() => {
        ...
        axios.post(`http://127.0.0.1:8080/home/user/getPosts`, {jwtToken:localStorage.getItem("token"), start, end, type:'meme', uId:JSON.parse(localStorage.getItem("data")).uId})
        .then(response => {
